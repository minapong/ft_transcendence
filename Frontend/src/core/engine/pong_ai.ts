...
export function updateAIParameters() {
...
export class PongAI {
    ...
    // Dynamic getters to ensure we always use the latest calculated dimensions
    private get GAME_WIDTH() { return PLAYABLE_WIDTH; }
    private get GAME_HEIGHT() { return PLAYABLE_HEIGHT; }
    private get PADDLE_HEIGHT() { return PADDLE_HEIGHT; }
    private get BALL_SIZE() { return BALL_SIZE; }
    private get PADDLE_X() { return RIGHT_PADDLE_X; }
