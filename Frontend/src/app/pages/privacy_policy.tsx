...
const sections: Section[] = [
  {
    ...
    bullets: [
      ...
      "Technical metadata: IP address, device/browser info, timestamps, and logs for security/debugging.",
  ...
  },
  {
    ...
    bullets: [
      ...
      "We do not use personal data for ads; limited sharing is only to operate logins/storage as listed below.",
    ],
  },
  {
    id: "data-protection",
    ...
    bullets: [
      ...
      "Sensitive fields (tokens, session secrets) are encrypted at rest using standard AES-based storage by providers.",
    ],
  },
  {
    id: "your-rights",
    ...
    bullets: [
      ...
      "To exercise rights, use the Contact page or the in-app request flow; we respond as quickly as possible.",
    ],
  },
  {
    ...
    bullets: [
      ...
      "Features can change, be rate-limited, or become unavailable; critical changes are announced in-app when possible.",
  ...
  },
  {
    ...
    bullets: [
      ...
      "We may use infrastructure/logging/storage providers for reliability; they process data under safeguards.",
  ...
  },
  {
    ...
    bullets: [
      ...
      "If you delete your account, public match summaries may remain in anonymized or aggregate form for integrity.",
    ],
  },
  {
    id: "changes",
    ...
    bullets: [
      ...
      "Material updates will be dated below and announced in-app when possible.",
      ...
      <div className="legal-shell">
        <header className="legal-hero">
          ...
          <div className="legal-meta">
            ...
            <span>
              <strong>Scope:</strong> Account, gameplay, and social data
            </span>
          </div>
        </header>

        <div className="legal-layout">
          <section className="legal-content" aria-label="Privacy sections">
